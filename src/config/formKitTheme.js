...
const textFieldStyles = {
    ...
    inner: `
        ...
        `,
    input: 'w-full h-10 px-4 border-none text-base text-gray-700 placeholder-gray-400',
...
export default {
    ...
    'family:button': {
        input: '$reset inline-flex items-center bg-primary-color text-white text-sm font-normal py-3 px-6 rounded',
        wrapper: 'mb-1',
